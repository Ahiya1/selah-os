...
-- Step 1: Drop NOT NULL constraints and change defaults to NULL.
-- This MUST come before the backfill below: setting a column to NULL while
-- it still carries a NOT NULL constraint raises a not-null violation.
...
-- Step 2: Backfill existing false values to NULL.
